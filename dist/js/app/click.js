...
// const CLICK_address = '0x552F012F489ef630D4b5a3DE78557135D2E56128';
    ...
    Promise.all([_ECHP_Balance, _clicksByAddress, _scores, _timeLeft, _timeLeftUntilNextClick])
        ...
        for (i = 0; i < scores.length; i++) {
            ...
            if (scores[i].player.toUpperCase() == currentAccount.toUpperCase()) {
                ...
                cell2.innerHTML = scores[i].player.match(/.{1,9}/g)[0] + "..(me)";
            } else {
                cell2.innerHTML = scores[i].player.match(/.{1,9}/g)[0] + "..";
            }
            cell1.innerHTML = i + 1;
